                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel bg-white p-5">
                        <div class="testimonial-item text-center">
                            ...
                            <h5 class="text-uppercase">Petra Petrović</h5>
                            <span>Lekar</span>
                        </div>
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-4">
                            ...
                            <p>Labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat. Erat dolor rebum sit ipsum. Dolores sed duo clita tempor justo dolor et stet lorem kasd.</p>
                            <hr class="w-25 mx-auto">
                            <h5 class="text-uppercase">Marko Marković</h5>
                            <span>Ekolog</span>
                        </div>
                    </div>
                </div>
